...
export function shirtRailMarkup(assetBase='/shirt-rail/'){
  ...
  return `<div class="shirt-rail is-loading" style="--kit-count:${kits.length};--rack-cols:${RACK_COLUMNS};--rack-rows:${RACK_ROWS}"><section class="rack-room" aria-label="Football shirt collection"><div class="rack-strip" role="listbox" aria-label="Football shirt collection"><div class="rack-track">${rows}</div></div><div class="rack-loader" aria-hidden="true"><div class="rack-loader-pattern"></div><img class="rack-poster" src="${posterSrc}" alt="" decoding="async" fetchpriority="high"></div></section>`
    + `<dialog aria-modal="true" aria-labelledby="shirt-rail-club" aria-describedby="shirt-rail-year shirt-rail-kit-type"><div class="dialog-panel"><button class="close" type="button" aria-label="Close shirt details"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18"/></svg></button><div class="dialog-logo-stage"><img class="dialog-logo" alt="" width="180" height="180" decoding="async"><span class="dialog-logo-fallback" aria-hidden="true"></span></div><div class="dialog-copy"><h2 class="dialog-club" id="shirt-rail-club"></h2><dl class="dialog-meta"><div><dt>Season</dt><dd id="shirt-rail-year"></dd></div><div><dt>Kit type</dt><dd id="shirt-rail-kit-type"></dd></div></dl></div></div></dialog></div>`;
}
